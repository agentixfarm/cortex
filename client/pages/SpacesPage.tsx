...
import { LayoutGrid, List, ArrowUpDown, FileText, FolderOpen } from "lucide-react";
import { useSpaces } from "../hooks/useTauri";
  ...
  return (
    ...
    >
      <div className="space-y-3">
        ...
        <div>
          <p className="font-semibold text-text-primary text-lg">{space.name}</p>
        ...
        {space.sampleFiles.length > 0 && (
          <div className="space-y-1 pt-1">
            {space.sampleFiles.slice(0, 3).map((file) => (
              <div key={file} className="flex items-center gap-1.5 text-xs text-text-tertiary">
