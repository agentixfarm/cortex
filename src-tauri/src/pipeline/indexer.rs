...
use crate::pipeline::{embedder::EmbeddingService, entities::EntityExtractor, hasher, parser};
...
mod tests {
    ...
    fn test_index_new_file_succeeds() {
        ...
        let doc_id = indexer
            .index_file(f.path(), &engine, &embedding_service)
